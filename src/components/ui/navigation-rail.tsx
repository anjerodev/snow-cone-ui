...
>(({ className, ...props }, ref) => (
  <aside
    ref={ref}
    className={cn(
      'navigation-rail fixed inset-x-0 bottom-0 z-30 flex justify-between bg-surfaceContainer py-4 pt-3 md:-inset-x-px md:inset-y-0 md:w-[88px] md:flex-col md:px-0 md:py-5',
      className
    )}
    {...props}
  />
...
const iconStyle =
  'group-hover:font-emphasis z-0 group-data-[active]:font-filled group-hover:group-data-[active]:font-filled-emphasis'
...
const itemStyle =
  'relative group grid w-full place-items-center gap-y-1 font-normal outline-none md:p-0.5'
